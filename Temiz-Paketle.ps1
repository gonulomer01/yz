...
$HaricTutulanlar = @("bin", "obj", ".vs", ".git", "GeminiChromeProfile_*", "*.db", "*.db-shm", "*.db-wal", "*.mdf", "*.ldf", "ai_automation_project_*", "*.zip", "*.ps1")
...
foreach ($dir in @($GeneratedDir, $GeneratedFreeDir, $GeneratedGeminiDir, $GeneratedStabilityDir)) {
...
$TemizCreds = [ordered]@{
    StabilityApiKeys = @(
        [ordered]@{ Id = 1; Label = "Kurumsal Anahtar #1"; KeyValue = ""; Status = "Active"; UsageToday = 0; TotalUsage = 0 },
        [ordered]@{ Id = 2; Label = "Kurumsal Anahtar #2"; KeyValue = ""; Status = "Active"; UsageToday = 0; TotalUsage = 0 },
        [ordered]@{ Id = 3; Label = "Kurumsal Anahtar #3"; KeyValue = ""; Status = "Active"; UsageToday = 0; TotalUsage = 0 },
        [ordered]@{ Id = 4; Label = "Kurumsal Anahtar #4"; KeyValue = ""; Status = "Active"; UsageToday = 0; TotalUsage = 0 },
        [ordered]@{ Id = 5; Label = "Kurumsal Anahtar #5"; KeyValue = ""; Status = "Active"; UsageToday = 0; TotalUsage = 0 },
        [ordered]@{ Id = 6; Label = "Kurumsal Anahtar #6"; KeyValue = ""; Status = "Active"; UsageToday = 0; TotalUsage = 0 },
        [ordered]@{ Id = 7; Label = "Kurumsal Anahtar #7"; KeyValue = ""; Status = "Active"; UsageToday = 0; TotalUsage = 0 },
        [ordered]@{ Id = 8; Label = "Kurumsal Anahtar #8"; KeyValue = ""; Status = "Active"; UsageToday = 0; TotalUsage = 0 },
        [ordered]@{ Id = 9; Label = "Kurumsal Anahtar #9"; KeyValue = ""; Status = "Active"; UsageToday = 0; TotalUsage = 0 },
        [ordered]@{ Id = 10; Label = "Kurumsal Anahtar #10"; KeyValue = ""; Status = "Active"; UsageToday = 0; TotalUsage = 0 }
    )
    CurrentKeyIndex = 0
    LastResetDate = (Get-Date -Format "yyyy-MM-dd")
    GeminiAccounts = @(
        [ordered]@{ Id = 1; ProfileName = "GeminiChromeProfile_1"; AccountLabel = "Google Hesap #1 (Ana Profil)"; Status = "Active"; LastUsed = "" },
        [ordered]@{ Id = 2; ProfileName = "GeminiChromeProfile_2"; AccountLabel = "Google Hesap #2"; Status = "Active"; LastUsed = "" },
        [ordered]@{ Id = 3; ProfileName = "GeminiChromeProfile_3"; AccountLabel = "Google Hesap #3"; Status = "Active"; LastUsed = "" },
        [ordered]@{ Id = 4; ProfileName = "GeminiChromeProfile_4"; AccountLabel = "Google Hesap #4"; Status = "Active"; LastUsed = "" }
    )
    CurrentGeminiProfileIndex = 0
}

$TemizCredsJson = $TemizCreds | ConvertTo-Json -Depth 5
